...
export default function Projects() {
    ...
    const filtered = activeFilter === 'All' ? projects : projects.filter(p => p.category === filterMap[activeFilter]);
        ...
        <section id="projects" ref={ref} className="projects-section">
              <div className="container">
                      <div className="section-header reveal">
                                <p className="section-label">My Work</p>p>
                                <h2 className="section-title">Featured <span className="grad-text">Projects</span>span></h2>h2>
                                <p className="section-subtitle">Things I&apos;ve built that I&apos;m proud of.</p>p>
                      </div>div>
                ...
                {/* Grid */}
                      ...
                      <div
                                    ...
                                    <div className="project-thumb" style={{ background: p.gradient }}>
                                                    <span className="project-emoji">{p.emoji}</span>span>
                                      {p.featured && <span className="featured-badge">* Featured</span>span>}
                                    </div>div>
                      
                                    <div className="project-body">
                                                    <h3 className="project-title">{p.title}</h3>h3>
                                                    <p className="project-desc">{p.desc}</p>p>
                                                    <div className="project-tags">
                                                      {p.tags.map(t => <span className="skill-pill" key={t}>{t}</span>span>)}
                                                    </div>div>
                                                    <div className="project-links">
                                                                      <a href={p.github} className="proj-link" aria-label="GitHub">
                                                                                          <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.166 6.839 9.489.5.092.682-.217.682-.483 0-.237-.009-.868-.013-1.703-2.782.605-3.369-1.342-3.369-1.342-.454-1.154-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.091-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.577 9.577 0 0 1 12 6.836c.85.004 1.705.115 2.504.337 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.202 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.579.688.481C19.138 20.161 22 16.416 22 12c0-5.523-4.477-10-10-10z"/></svg>svg>
                                                                                          Code
                                                                      </a>a>
                                                                      <a href={p.live} className="proj-link proj-live" aria-label="Live">
                                                                                          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>svg>
                                                                                          Live Demo
                                                                      </a>a>
                                                    </div>div>
                                    </div>div>
                ...
                {/* Ongoing Project Section */}
                      <div className="section-header reveal" style={{ marginTop: '5rem' }}>
                                <h2 className="section-title">Ongoing <span className="grad-text">Project</span>span></h2>h2>
                                <p className="section-subtitle">Current works in progress.</p>p>
                      </div>div>
                      ...
                      <div className="projects-grid">
                                <div className="project-card glass-card reveal">
                                            <div className="project-thumb" style={{ background: 'linear-gradient(135deg, #6366f1 0%, #a855f7 100%)' }}>
                                                          <span className="project-emoji">(clock)</span>span>
                                            </div>div>
                                            <div className="project-body">
                                                          <h3 className="project-title">Clockmaker&apos;s Curse</h3>h3>
                                                          ...
                                                          <div className="project-tags">
                                                                          <span className="skill-pill">Ongoing</span>span>
                                                                          <span className="skill-pill">Mystery</span>span>
                                                                          <span className="skill-pill">Web Dev</span>span>
                                                          </div>div>
                                                          <div className="project-links">
